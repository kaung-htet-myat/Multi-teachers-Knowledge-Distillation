...
def resnet_student_wo_GT(input_shape, temperature, body_depth, num_head, num_blocks_head, num_classes=10):
    ...
    for i in range(num_head):
        ...
        head = Activation('softmax', name= 'soft_prob_1')(soft_logits)
        heads.append(head)
